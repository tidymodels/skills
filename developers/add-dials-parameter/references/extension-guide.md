...
After creating your parameter, you should have **exactly 3 core files**:

1. **R/param_[name].R** - Your parameter function with roxygen documentation
...
- ❌ MANIFEST.md
- ❌ INDEX.md
- ❌ Any other supplementary documentation
...
- Parameter code goes in R/ file with roxygen @examples
- Tests go in tests/testthat/ file
- Brief overview goes in README.md if needed
- Nothing else should be created

**Why this matters:** Additional files create clutter without adding value. All necessary documentation belongs in roxygen comments and README.
