...
For extension development (creating new packages), see [Troubleshooting (Extension)](../shared-references/troubleshooting-extension.md).
...
- See [Extension Troubleshooting](../shared-references/troubleshooting-extension.md) for general R package issues
